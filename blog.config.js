...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '12b17a886c8f80b69e6df68b5f273f54',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '|“开源铸就共创，共创成就开源”|', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zhz.hkg1.zeabur.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ZHNGYUZY842530@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  // 网站字体
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-serif', // ['HarmonyOS_Regular','Apple Color Emoji'] 两种可选，分别是衬线和无衬线: 参考 https://www.jianshu.com/p/55e410bd2115
  FONT_URL: [
